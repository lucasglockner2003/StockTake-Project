...
function ReviewPage({
  ...
  const itemsToOrder = suggestedOrder.filter((item) => item.orderAmount > 0);
  ...
  return (
    <div>
      ...
      >
        ...
        <div style={badgeStyle("#ffebee", "#ff4d4d")}>
      ...
      {itemsToOrder.length === 0 ? (
        <div style={styles.emptyState}>No items need ordering.</div>
      ) : (
        <>
          <div
            style={{
